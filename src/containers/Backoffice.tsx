...
import {
    BackofficeContainer
} from "../styled-components/Backoffice";
...
const columns: GridColDef[] = [
    ...
    {
        field: 'action', headerName: 'Acción', width: 80, renderCell: (params) => {
            return (
                <ActionMenu>
